/**
 * Lightweight QR Code Generator for Chrome Extension
 * Based on public domain QR code algorithms
 */
(function(global) {
    'use strict';
    ...
    // Polynomial calculator for error correction
    class QRPolynomial {
    ...
    // Math utilities for QR code generation
    const QRMath = {
        glog: function(n) {
            if (n < 1) {
        ...
        toCanvas: function(canvas, text, options) {
            return new Promise((resolve, reject) => {
                try {
                    ...
                    let errorCorrectLevel;
                    switch (errorCorrectionLevel) {
                        case 'L': errorCorrectLevel = ErrorCorrectLevel.L; break;
                        case 'M': errorCorrectLevel = ErrorCorrectLevel.M; break;
                        case 'Q': errorCorrectLevel = ErrorCorrectLevel.Q; break;
                        case 'H': errorCorrectLevel = ErrorCorrectLevel.H; break;
                        default: errorCorrectLevel = ErrorCorrectLevel.H;
                    }

                    // Determine the minimum type number needed
                    let typeNumber = 1;
                    for (let i = 1; i <= 10; i++) {
